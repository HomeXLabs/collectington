...
def get_list_of_available_metrics(config, service_name):
    ...
    """
    try:
        metrics_mapping = get_service_config(config, service_name)["prometheus_metrics_mapping"]
...
def get_service(config, service_name):
    ...
    try:
        service = get_service_config(config, service_name)["service_class"]
        service_module = get_service_config(config, service_name)["service_module"]
