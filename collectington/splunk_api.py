...
from collectington.utils import *
from collectington.config import *
from collectington.abstract_api import (
    AbstractApi,
    enable_delta_metric,
...
class SplunkApi(AbstractApi):
    ...
    def __init__(self):
        ...
        self.config = get_service_config("splunk")
        self.api_url = self.config["api_url"]

        dict_of_credentials = get_credentials_from_secret_file(
            self.config["additional_config"]["secret_file_path"]
        )
